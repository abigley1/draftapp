...
stats = pd.read_csv('/home/bigley/Desktop/springboard/Basketball_Project/app_data.csv')
stats= stats.set_index(['PlayerName', 'Full Year'])

nba_stats = pd.read_csv('/home/bigley/Desktop/springboard/Basketball_Project/nba_stats.csv')
